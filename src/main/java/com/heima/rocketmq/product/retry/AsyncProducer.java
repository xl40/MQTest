package com.heima.rocketmq.product.retry;
...
public class AsyncProducer {
    public static void main(String[] args) throws Exception {
        ...
        Message msg = new Message(
                ...
                "TagA",
                /* 消息内容 */
                ("Hello Java demo RocketMQ " + 0).getBytes(RemotingHelper.DEFAULT_CHARSET)
        );
        producer.send(msg, new SendCallback() {
            public void onSuccess(SendResult sendResult) {
                System.out.printf("%-10d " + sendResult.getSendStatus() + " %s %n", 0,
                        sendResult.getMsgId());
            }
